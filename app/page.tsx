    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex flex-col">
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row space-y-8 lg:space-y-0 lg:space-x-10 items-center justify-center max-w-7xl w-full">
          ...
          {/* Profile Content */}
          <div className="flex flex-col space-y-4 animate-fade-in delay-200 max-w-2xl text-center lg:text-left px-2">
            ...
            <p className="w-full text-sm sm:text-base leading-relaxed text-gray-700 animate-fade-in delay-300 indent-4 text-justify">
