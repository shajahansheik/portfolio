...
export default function Experience() {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-0'>
      ...
      <div className='space-y-6 sm:space-y-8 col-span-1 lg:col-span-2 px-4 sm:px-6'>
        {experienceData.experience.map((exp, index) => (
          <div 
            key={exp.id} 
            className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-10 text-sm p-3 sm:p-4 rounded-lg hover:bg-blue-50 transition-all duration-300 card-hover animate-slide-in-left'
