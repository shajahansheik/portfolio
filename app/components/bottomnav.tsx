...
export default function BottomNav() {
  return (
    <div className='flex items-center justify-between border-t mx-32 font-sans text-sm py-4 px-20'>
      <div className='flex flex-col space-y-1'><span className='text-gray-400'>Email</span><span>shajahan.j2se@gmail.com</span></div>
